    ...
    <div class="container py-5 animate-fade-up" style="max-width:640px">
        ...
        <div class="card overflow-hidden shadow">
            ...
            <div class="card-body p-4 p-md-5">
                @if($campaign)
                    <div class="rounded-4 p-3 mb-4" style="background:linear-gradient(90deg,#fef3e2,#ecfdf5);border:1px solid rgba(219,124,28,0.12)">
                ...
                <form action="{{ route('donations.store') }}" method="POST">
                    ...
                    <p class="text-center text-muted mt-3 d-flex align-items-center justify-content-center gap-1" style="font-size:12px">
                        <svg width="14" height="14" fill="none" stroke="#27ae60" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
