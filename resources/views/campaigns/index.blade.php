<x-layouts.public>
    ...
    <section class="hero-gradient py-5">
        ...
        <div class="hero-orb" style="width:500px;height:500px;top:-200px;right:-100px;background:rgba(99,102,241,0.12)"></div>
        <div class="hero-orb" style="width:400px;height:400px;bottom:-100px;left:-50px;background:rgba(245,158,11,0.08)"></div>
        ...
        <div class="container position-relative py-5" style="z-index:2">
            ...
            <p class="lead animate-fade-up" style="animation-delay:0.35s;color:rgba(199,210,254,0.7);max-width:520px">
    ...
    <section class="container py-5">
        ...
        @if($campaigns->count() === 0)
            <div class="card border-2 border-dashed text-center p-5 animate-fade-up">
                <div class="d-flex align-items-center justify-content-center rounded-4 mx-auto mb-3" style="width:64px;height:64px;background:linear-gradient(135deg,#eef2ff,#e0e7ff)">
                    <svg width="32" height="32" fill="none" stroke="#818cf8" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/></svg>
                </div>
                ...
                @foreach($campaigns as $index => $campaign)
                    ...
                    <div class="col-sm-6 col-lg-4 animate-fade-up" style="animation-delay:{{ 0.1 + ($index * 0.08) }}s;opacity:0">
                        <a href="{{ route('campaigns.show', $campaign->slug) }}" class="card card-hover h-100 text-decoration-none overflow-hidden">
                            {{-- Top gradient --}}
                            <div style="height:4px;background:linear-gradient(90deg,#4f46e5,#818cf8,#fbbf24)"></div>
