        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8 animate-fade-up">
                <div class="card overflow-hidden">
                    <div style="height:5px;background:linear-gradient(90deg,#4f46e5,#818cf8,#fbbf24)"></div>
                    <div class="card-body p-4 p-md-5">
                        ...
                        @if($campaign->end_date)
                            <div class="alert alert-warning d-inline-flex align-items-center gap-2 rounded-4 border-0 mt-3 py-2 px-3 small fw-medium" style="background:#fffbeb">
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="row g-3">
                            @foreach([['100%','Transparent Tracking','See exactly how funds are used'],['Fast','Instant Processing','Donations processed immediately'],['Safe','Secure Payments','Protected by Stripe & PayPal']] as $item)
                                <div class="col-sm-4">
                                    <div class="rounded-4 p-4 text-center" style="background:linear-gradient(135deg,#f8fafc,#f1f5f9);border:1px solid rgba(0,0,0,0.04)">
                ...
                <div class="card sticky-top" style="top:80px">
                    <div class="card-body p-4">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-6">
                                <div class="rounded-4 p-3 text-center" style="background:linear-gradient(135deg,#eef2ff,#fff)">
                            ...
                            <div class="col-6">
                                <div class="rounded-4 p-3 text-center" style="background:linear-gradient(135deg,#fffbeb,#fff)">
                        ...
                        <div class="border-top mt-3 pt-3 d-flex align-items-center gap-2 text-muted" style="font-size:12px">
                            <svg width="14" height="14" fill="none" stroke="#10b981" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
