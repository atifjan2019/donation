...
<div x-data="{ sidebarOpen: false }" class="d-flex min-vh-100">
    ...
    <aside class="sidebar d-flex flex-column" :class="sidebarOpen && 'show'">
        <div class="d-flex align-items-center gap-3 px-4 py-3 border-bottom" style="border-color:rgba(255,255,255,0.05)!important">
            <div class="d-flex align-items-center justify-content-center rounded-3" style="width:32px;height:32px;background:linear-gradient(135deg,#DB7C1C,#e8943a)">
            ...
            <div>
                ...
                <div class="fw-semibold text-uppercase" style="font-size:10px;color:rgba(219,124,28,0.6);letter-spacing:0.12em">Admin</div>
            </div>
        </div>
        ...
        <div class="px-3 py-3 border-top" style="border-color:rgba(255,255,255,0.05)!important">
            <div class="d-flex align-items-center gap-2 px-2 py-2 rounded-3">
                <div class="d-flex align-items-center justify-content-center rounded-circle text-white fw-bold" style="width:32px;height:32px;font-size:12px;background:linear-gradient(135deg,#DB7C1C,#e8943a)">
