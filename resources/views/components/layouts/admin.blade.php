    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        ...
        <div class="flex items-center gap-3 px-5 h-16 shrink-0 border-b border-white/5">
            ...
            <div>
                ...
                <p class="text-[10px] text-accent-400/70 font-semibold mt-0.5 uppercase tracking-[0.15em]">Admin</p>
            </div>
        </div>
        ...
        <div class="px-3 py-3 border-t border-white/5 shrink-0">
            <div class="flex items-center gap-3 px-2 py-2 rounded-xl hover:bg-white/5 transition-colors">
                <div class="w-8 h-8 bg-gradient-to-br from-brand-400 to-brand-600 text-white rounded-full flex items-center justify-center font-bold text-xs shrink-0 shadow-md shadow-brand-500/20">
