<x-layouts.admin>
    ...
    <div class="row g-3 mb-4">
        @foreach([
            ['Total Raised', '$'.number_format($totals['all_time'] / 100, 2), 'All time', '#4f46e5', 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1','#eef2ff'],
            ['This Month', '$'.number_format($totals['this_month'] / 100, 2), 'Current month', '#d97706', 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6','#fffbeb'],
            ['Total Donations', number_format($donation_count), 'All time count', '#d97706', 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z','#fef3c7'],
            ['Avg. Donation', '$'.number_format($average_donation / 100, 2), 'Per donation', '#9333ea', 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z','#f3e8ff'],
        ] as $s)
            ...
            <div class="card p-4">
                ...
                <div class="d-flex flex-column gap-2">
                    @forelse($recurring_vs_one_time as $item)
                        <div class="d-flex justify-content-between align-items-center rounded-4 px-3 py-3" style="background:#f8fafc">
                            <div>
                ...
                <div class="mt-4 pt-3 border-top d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center justify-content-center rounded-3" style="width:40px;height:40px;background:#ecfdf5">
                        <svg width="20" height="20" fill="none" stroke="#10b981" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18"/></svg>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row g-3">
        @foreach([
            [route('admin.donations.index'), 'All Donations', 'Manage and export', '#4f46e5', '#eef2ff', 'M4 6h16M4 10h16M4 14h16M4 18h16'],
            [route('admin.campaigns.index'), 'Manage Campaigns', 'Create or edit', '#d97706', '#fffbeb', 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10'],
            [route('admin.donations.index', array_merge(request()->query(), ['export' => 'csv'])), 'Export CSV', 'Download all donations', '#d97706', '#fffbeb', 'M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z'],
        ] as $a)
            <div class="col-sm-4">
